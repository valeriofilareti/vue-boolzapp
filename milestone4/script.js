...
createApp({
  ...
  mounted() {
    ...
    console.log(this.contacts[1].visible);
    console.log(this.contacts[2].visible);
    console.log(this.contacts[3].visible);
    console.log(this.contacts[4].visible);
    console.log(this.contacts[5].visible);
    console.log(this.contacts[6].visible);
  }
}).mount('#app')